...
const containerForBtns = document.querySelector(".btn-container");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  const categoryBtn = categoris
    ...
    .join("");
  containerForBtns.innerHTML = categoryBtn;
...
const displayMenuItems = function (menuItems) {
  ...
  // sectionCenter.insertAdjacentHTML(displayMenu);
